...
| [migration-popularity-producer.md](./migration-popularity-producer.md) | Partial recovery: `FUN_00591200` popularity sum/damping, `FUN_005917E0` pressure/request/cooldown, `FUN_004ADA10` assigned/accounted spawn accounting, `FUN_004ADE10` figure `#11` spawn, type-`0xB` dispatch through `FUN_004C7580` to `FUN_004C9FD0` (`house+0x20` add at `0x4CA265`), `house+0x24` lifecycle as a `DAT_01391FE0` land-entry-flood snapshot, house vtable `+0xB8` = `FUN_0042DD40` on `HouseBldg` `0x7ABA38` (`house+9 != 0`), and `+0x1E4` = `FUN_00416B50` returning `cHouseInfo` at `house+0xC8` (`+0x3C != 0` skips the occupancy add). Native occupancy stays fail-closed because food fields, monument matching, war-figure mapping, mode writer, Native `+0x24` mapping, and `DAT_00D62408` remain unknown. `cHouseInfo+0x3C` method identity and occupancy-add skip polarity are closed; original semantic name, complete writer/lifecycle set, and Native mapping are not |
